            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  className="w-full bg-[rgba(0,4,19,0.5)] border-2 border-[var(--accent-cyan)] text-white rounded-lg
            ...
            <div className="mt-8 pt-8 border-t-2 border-[var(--accent-cyan)]/40">
              ...
              <div className="flex justify-center gap-4">
                {[ 
                  ...
                  { Icon: Linkedin, href: 'https://www.linkedin.com/in/aghyad-fanous-29874b38b/' },
                  ...
                  <a
                    ...
                    className="p-3 border-2 border-[var(--accent-cyan)] text-[var(--accent-cyan)] rounded-lg
                               hover:bg-[var(--accent-cyan)] hover:text-[var(--bg-primary)]
